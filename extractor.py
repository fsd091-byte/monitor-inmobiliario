...
def obtener_pisos_idealista():
    ...
    print("🔍 Conectando con Apify para buscar inmuebles en Guadalajara (100k - 175k)...")
    ...
    try:
        ...
        for item in items_raw:
            ...
            piso = {
                ...
                "zone": item.get("municipality") or item.get("district") or item.get("address", "Guadalajara"),
            ...
            pisos_normalizados.append(piso)
            
        # Opcional pero muy útil: guardar automáticamente el resultado fresco en el JSON
        with open("pisos_guadalajara.json", "w", encoding="utf-8") as f:
            json.dump(pisos_normalizados, f, ensure_ascii=False, indent=4)
        print(f"💾 Guardados {len(pisos_normalizados)} pisos frescos en 'pisos_guadalajara.json'.")
...
def obtener_pisos_idealistaVERSIONANTERIOR():
